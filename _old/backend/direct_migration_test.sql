-- Script para criar as tabelas de Atas diretamente
...
ALTER TABLE "PrazoAcao" ADD CONSTRAINT "PrazoAcao_acaoId_fkey" FOREIGN KEY ("acaoId") REFERENCES "AtaComentario"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey para LogAlteracaoAta se existir
DO $$ 
BEGIN
...
-- Sucesso
SELECT 'Migration completed successfully' as resultado;
