      ...
      {alertaIdFromUrl && (
        <section className="rounded-xl border border-sky-200 bg-sky-50 p-3 shadow-sm dark:border-sky-800 dark:bg-sky-900/30">
          <div className="flex items-center justify-between">
            ...
            <Link
              href={uploadIdFromUrl ? `/admin/resultado-economico/alertas?uploadId=${uploadIdFromUrl}` : '/admin/resultado-economico/alertas'}
              ...
              <tbody className="divide-y divide-border">
                {alertasList.map((alerta) => {
                  ...
                  return (
                    <tr
                      key={alerta.id}
                      onClick={() => router.push(`/admin/resultado-economico/alertas/${alerta.id}`)}
