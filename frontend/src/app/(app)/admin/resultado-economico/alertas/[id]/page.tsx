  ...
  if (isLoading) {
    return (
      <div className="flex items-center justify-center py-12">
        <div className="text-sm text-muted-foreground">Carregando detalhes do alerta...</div>
      </div>
    );
  }
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-start justify-between">
        <div className="flex-1">
          <Link
            href="/admin/resultado-economico/alertas"
          ...
          <div className="flex flex-wrap items-center gap-4 text-sm text-muted-foreground dark:text-slate-400">
            ...
            {alerta.upload?.empresa && (
              <div className="flex items-center gap-2">
                ...
                <Link
                  href={`/admin/resultado-economico/alertas?empresaId=${alerta.upload.empresa?.id}`}
      ...
      <div className="rounded-xl border border-border bg-card p-4 shadow-sm">
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1">
            <p className="text-sm font-medium text-foreground dark:text-slate-50 mb-1">Mensagem do Alerta</p>
            <p className="text-sm text-muted-foreground dark:text-slate-400">{alerta.mensagem}</p>
          </div>
        </div>
      </div>
        ...
        {abaAtiva === 'visao-geral' && (
          <div className="space-y-6">
            ...
            <section className="rounded-xl border border-border bg-card p-6 shadow-sm">
              <h2 className="text-lg font-semibold text-foreground dark:text-slate-50 mb-4">
                Informações Básicas
              </h2>
              <div className="grid gap-4 sm:grid-cols-2">
                <div>
                  <label className="text-xs font-medium text-muted-foreground dark:text-slate-400">ID</label>
                  <p className="text-sm font-mono text-foreground dark:text-slate-50">{alerta.id}</p>
                </div>
                <div>
                  <label className="text-xs font-medium text-muted-foreground dark:text-slate-400">Tipo</label>
                  <p className="text-sm text-foreground dark:text-slate-50">
                    {tipoLabels[alerta.tipo] || alerta.tipo}
                  </p>
                </div>
                <div>
                  <label className="text-xs font-medium text-muted-foreground dark:text-slate-400">Severidade</label>
                  <p className="text-sm text-foreground dark:text-slate-50">
                    {getStatusLabel(alerta.severidade)}
                  </p>
                </div>
                ...
                <div>
                  <label className="text-xs font-medium text-muted-foreground dark:text-slate-400">Criado em</label>
                  <p className="text-sm text-foreground dark:text-slate-50">
            ...
            {alerta.linha && (
              <section className="rounded-xl border border-border bg-card p-6 shadow-sm">
                ...
                <div className="grid gap-4 sm:grid-cols-2">
                  ...
                  <div>
                    <label className="text-xs font-medium text-muted-foreground dark:text-slate-400">Nível</label>
                    <p className="text-sm text-foreground dark:text-slate-50">
                  ...
                  <div>
                    <label className="text-xs font-medium text-muted-foreground dark:text-slate-400">Débito</label>
                    <p className="text-sm text-foreground dark:text-slate-50">
                      {new Intl.NumberFormat('pt-BR', {
                        style: 'currency',
                        currency: 'BRL',
                  ...
                  <div>
                    <label className="text-xs font-medium text-muted-foreground dark:text-slate-400">Crédito</label>
                    <p className="text-sm text-foreground dark:text-slate-50">
                      {new Intl.NumberFormat('pt-BR', {
                        style: 'currency',
                        currency: 'BRL',
              ...
              <section className="rounded-xl border border-amber-200 bg-amber-50 p-6 shadow-sm dark:border-amber-800 dark:bg-amber-900/20">
                ...
                <div className="grid gap-4 sm:grid-cols-2">
                  <div className="rounded-lg border border-amber-200 bg-card p-4 dark:border-amber-800">
                    ...
                    <p className="text-lg font-semibold text-foreground dark:text-slate-50 mt-1">
                      {new Intl.NumberFormat('pt-BR', {
                        style: 'currency',
                        currency: 'BRL',
                      }).format(comparacaoTemporal.mesAnterior.saldoAtual)}
                    </p>
                    <p className="text-xs text-muted-foreground dark:text-slate-400 mt-1">Saldo Atual</p>
                  </div>
                  <div className="rounded-lg border border-amber-200 bg-card p-4 dark:border-amber-800">
                    <label className="text-xs font-medium text-muted-foreground dark:text-slate-400">
                    ...
                    <p className="text-xs text-muted-foreground dark:text-slate-400 mt-1">Saldo Anterior</p>
                  </div>
                </div>
                <div className="mt-4 rounded-lg border border-amber-300 bg-amber-100 p-4 dark:border-amber-700 dark:bg-amber-900/30">
                  <div className="flex items-center justify-between">
                    <span className="text-sm font-medium text-foreground dark:text-slate-50">
                      Diferença Detectada:
                    </span>
        ...
        {abaAtiva === 'historico' && (
          <div className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm dark:border-slate-800 dark:bg-slate-900/70">
            <div className="flex items-center justify-between mb-4">
              <h2 className="text-lg font-semibold text-foreground dark:text-slate-50">
            ...
            <div className="mb-6 rounded-lg border border-border bg-muted p-4">
              <div className="flex items-center gap-2 mb-3">
                ...
                <h3 className="text-sm font-semibold text-foreground dark:text-slate-50">Filtros Avançados</h3>
              </div>
              <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
                ...
                <div>
                  ...
                  <select
                    ...
                    disabled={!anoInicio}
                    className="w-full rounded-md border border-slate-300 bg-white px-3 py-2 text-sm text-foreground focus:border-sky-500 focus:outline-none focus:ring-2 focus:ring-sky-500/40 disabled:opacity-50 disabled:cursor-not-allowed dark:border-slate-700 dark:bg-slate-800 dark:text-slate-100"
                  >
                    <option value="">Todos</option>
                    {meses.map((mes) => (
            ...
            {historicoFiltrado && historicoFiltrado.length > 0 ? (
              <div className="space-y-6">
                ...
                {estatisticasFiltradas && (
                  <div className="grid gap-4 sm:grid-cols-4 mb-6">
                    ...
                    <div className="rounded-lg border border-border bg-muted p-4">
                      <label className="text-xs font-medium text-muted-foreground dark:text-slate-400">Máximo</label>
                      <p className="text-lg font-semibold text-foreground dark:text-slate-50 mt-1">
                        {new Intl.NumberFormat('pt-BR', {
                          style: 'currency',
                          currency: 'BRL',
                    ...
                    <div className="rounded-lg border border-border bg-muted p-4">
                      <label className="text-xs font-medium text-muted-foreground dark:text-slate-400">Mínimo</label>
                      <p className="text-lg font-semibold text-foreground dark:text-slate-50 mt-1">
                        {new Intl.NumberFormat('pt-BR', {
                          style: 'currency',
                          currency: 'BRL',
                    ...
                    <div className="rounded-lg border border-border bg-muted p-4">
                      <label className="text-xs font-medium text-muted-foreground dark:text-slate-400">Tendência</label>
                ...
                <div className="overflow-x-auto">
                  <table className="min-w-full divide-y divide-slate-200 text-xs dark:divide-slate-800">
                    <thead className="bg-muted">
                      <tr>
                        <th className="px-3 py-2 text-left text-xs font-medium text-muted-foreground">Mês/Ano</th>
                        <th className="px-3 py-2 text-left text-xs font-medium text-muted-foreground">
                          Saldo Anterior
                        </th>
                        <th className="px-3 py-2 text-left text-xs font-medium text-muted-foreground">Débito</th>
                        <th className="px-3 py-2 text-left text-xs font-medium text-muted-foreground">Crédito</th>
                        <th className="px-3 py-2 text-left text-xs font-medium text-muted-foreground">Saldo Atual</th>
                    ...
                    <tbody className="divide-y divide-slate-200 dark:divide-slate-800">
                      {historicoFiltrado.map((item, index) => {
                        ...
                        return (
                          ...
                          >
                            <td className="px-3 py-2 whitespace-nowrap text-foreground dark:text-slate-50">
                              {item.mes}/{item.ano}
                            </td>
                            <td className="px-3 py-2 text-foreground dark:text-slate-300">
                              {new Intl.NumberFormat('pt-BR', {
                                style: 'currency',
                                currency: 'BRL',
                            ...
                            <td className="px-3 py-2 font-semibold text-foreground dark:text-slate-50">
                              {new Intl.NumberFormat('pt-BR', {
                                style: 'currency',
                                currency: 'BRL',
              ...
              <div className="rounded-lg border border-amber-200 bg-amber-50 p-4 dark:border-amber-800 dark:bg-amber-900/20">
                <p className="text-sm font-medium text-foreground dark:text-slate-50 mb-1">
              ...
              <p className="text-sm text-muted-foreground">Nenhum histórico disponível para esta conta.</p>
            )}
          </div>
        )}
              ...
              <section className="rounded-xl border border-amber-200 bg-amber-50 p-6 shadow-sm dark:border-amber-800 dark:bg-amber-900/20">
                ...
                <div className="grid gap-4 sm:grid-cols-2 mb-4">
                  <div className="rounded-lg border border-amber-200 bg-card p-4 dark:border-amber-800">
                    ...
                    <p className="text-2xl font-bold text-foreground dark:text-slate-50 mt-2">
                      {new Intl.NumberFormat('pt-BR', {
                        style: 'currency',
                        currency: 'BRL',
                      }).format(comparacaoTemporal.mesAnterior.saldoAtual)}
                    </p>
                    <p className="text-xs text-muted-foreground dark:text-slate-400 mt-1">Saldo Atual do Mês Anterior</p>
                  </div>
                  <div className="rounded-lg border border-amber-200 bg-card p-4 dark:border-amber-800">
                    <label className="text-xs font-medium text-muted-foreground dark:text-slate-400">
                      Mês Atual ({comparacaoTemporal.mesAtual.mes}/{comparacaoTemporal.mesAtual.ano})
                    ...
                    <p className="text-xs text-muted-foreground dark:text-slate-400 mt-1">Saldo Anterior do Mês Atual</p>
                  </div>
                </div>
                <div className="rounded-lg border border-amber-300 bg-amber-100 p-4 dark:border-amber-700 dark:bg-amber-900/30">
                  <div className="flex items-center justify-between mb-2">
                    <span className="text-sm font-semibold text-foreground dark:text-slate-50">
                      Diferença Detectada:
                    </span>
                    <span
                  ...
                  <div className="mt-3 space-y-2">
                    <p className="text-xs font-medium text-foreground dark:text-slate-300">
                      ⚠️ Alteração Retroativa Detectada
                    </p>
                    <p className="text-xs text-muted-foreground dark:text-slate-400">
                      O saldo do mês anterior foi modificado retroativamente. Isso pode indicar:
                    </p>
                    <ul className="text-xs text-muted-foreground dark:text-slate-400 list-disc list-inside ml-2 space-y-1">
              ...
              <section className="rounded-xl border border-border bg-card p-6 shadow-sm">
                ...
                {historico.filter((h) => h.temAlerta).length > 0 && (
                  <div className="mt-4 rounded-lg border border-amber-200 bg-amber-50 p-4 dark:border-amber-800 dark:bg-amber-900/20">
                    <p className="text-sm font-medium text-foreground dark:text-slate-50 mb-2">
            ...
            {estatisticas && (
              <section className="rounded-xl border border-border bg-card p-6 shadow-sm">
                ...
                <div className="grid gap-4 sm:grid-cols-3">
                  <div className="rounded-lg border border-slate-200 bg-slate-50 p-4 dark:border-slate-700 dark:bg-slate-800">
                    <label className="text-xs font-medium text-muted-foreground dark:text-slate-400">Valor Atual</label>
                    <p className="text-lg font-semibold text-foreground dark:text-slate-50 mt-1">
                      {historico && historico.length > 0
                        ? new Intl.NumberFormat('pt-BR', {
                            style: 'currency',
                  ...
                  <div className="rounded-lg border border-slate-200 bg-slate-50 p-4 dark:border-slate-700 dark:bg-slate-800">
                    <label className="text-xs font-medium text-muted-foreground dark:text-slate-400">Valor Médio</label>
                    <p className="text-lg font-semibold text-foreground dark:text-slate-50 mt-1">
                      {new Intl.NumberFormat('pt-BR', {
                        style: 'currency',
                        currency: 'BRL',
                  ...
                  <div className="rounded-lg border border-slate-200 bg-slate-50 p-4 dark:border-slate-700 dark:bg-slate-800">
                    <label className="text-xs font-medium text-muted-foreground dark:text-slate-400">Desvio</label>
                    <p
              ...
              <div className="flex flex-wrap gap-3">
                ...
                {alerta.status === 'EM_ANALISE' && (
                  <>
                    <button
                      ...
                      disabled={updateStatusMutation.isPending}
                      className="inline-flex items-center gap-2 rounded-md bg-muted px-4 py-2 text-sm font-medium text-foreground hover:bg-muted/80 disabled:opacity-50"
                    >
                      <X className="h-4 w-4" />
                      Reabrir Alerta
                    </button>
                ...
                {alerta.status === 'RESOLVIDO' && (
                  <button
                    onClick={() => handleUpdateStatus('ABERTO')}
                    disabled={updateStatusMutation.isPending}
                    className="inline-flex items-center gap-2 rounded-md bg-slate-50 px-4 py-2 text-sm font-medium text-foreground hover:bg-slate-100 disabled:opacity-50 dark:bg-slate-700 dark:text-slate-200 dark:hover:bg-slate-600"
                  >
                    <X className="h-4 w-4" />
                    Reabrir Alerta
                  </button>
                ...
                <div className="space-y-2">
                  {alertasRelacionados.map((alertaRel) => (
                    <Link
                      ...
                      className="block rounded-lg border border-border bg-muted p-3 hover:bg-muted/80"
                    >
                      <div className="flex items-center justify-between">
                        <div>
